                    ...
                    {{-- <hr> --}}
                      <li>
                          ...
                          @if (Session::has('coupon'))
                            ...
                            <strong>Grand Total: </strong> ${{ session()->get('coupon')['total_amount'] }} <br><br>
                          @else
...
var stripe = Stripe('pk_test_51IIVL8KzalqmeBimysWX1B0IEkvQ4PT0t3UOjitl5hmDq4qLCSj8Fz0OHsdKNBJ03sIrNobgRam6CQcaii4ANFJK00wq21AgcZ');
