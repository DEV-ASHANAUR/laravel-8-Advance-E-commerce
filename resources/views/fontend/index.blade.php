		  ...
		  <div class="item">
			<div class="products">
			  <div class="hot-deal-wrapper">
				<div class="image">
				  <img
					src="{{asset('fontend')}}/assets/images/hot-deals/p25.jpg"
					alt=""
				  />
				</div>
		  ...
		  <div class="item">
			<div class="products">
			  <div class="hot-deal-wrapper">
				<div class="image">
				  <img
					src="{{asset('fontend')}}/assets/images/hot-deals/p5.jpg"
					alt=""
				  />
				</div>
				<div class="sale-offer-tag">
		  ...
		  <div class="item">
			<div class="products">
			  <div class="hot-deal-wrapper">
				<div class="image">
				  <img
					src="{{asset('fontend')}}/assets/images/hot-deals/p10.jpg"
					alt=""
				  />
				</div>
				<div class="sale-offer-tag">
				...
				<div class="product-micro">
					...
					<div class="col col-xs-5">
						...
						<div class="image">
							<a href="#">
							<img
								src="{{asset('fontend')}}/assets/images/products/p29.jpg"
								alt=""
							/>
							</a>
						</div>
