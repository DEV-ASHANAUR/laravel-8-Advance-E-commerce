...
<div id="brands-carousel" class="logo-slider wow fadeInUp">
		...
		<div class="logo-slider-inner">	
			<div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
				...
				<div class="item">
					<a href="#" class="image">
						<img data-echo="assets/images/brands/brand5.png" src="{{ asset('fontend') }}/assets/images/blank.gif" alt="">
					</a>	
				</div><!--/.item-->

				<div class="item">
					<a href="#" class="image">
						<img data-echo="assets/images/brands/brand6.png" src="{{ asset('fontend') }}/assets/images/blank.gif" alt="">
					</a>	
				</div><!--/.item-->
