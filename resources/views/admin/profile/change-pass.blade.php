            ...
            <div class="card-body">
                <form class="register-form outer-top-xs" role="form" action="{{ route('password.update') }}" method="POST" data-parsley-validate id="selectForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="old" class="form-control unicase-form-control text-input" id="old-password" required />
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" class="form-control unicase-form-control text-input" data-equalto="#password" id="password_confirmation" required />
                    </div>
