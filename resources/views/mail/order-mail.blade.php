...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">You Are Receiving This Email because we received Your Order .<br> Your Order Details: </p>
...
<tr>
    <td>
        <strong>Invoice No : </strong><mark>{{ $order['invoice_no'] }}</mark>
    </td>
</tr>
<tr>
    <td>
        <strong>Total Amount : </strong><mark>{{ number_format($order['amount'],2) }} Tk</mark>
    </td>
</tr>
<tr>
    <td>
        <strong> We Are Preparing Your Order. </strong>
    </td>
</tr>
<tr>
    <td>
